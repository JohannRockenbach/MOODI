...
class CajaPolicy
{
    ...
    {
        return $user->can('force_delete_caja');
    }
    ...
    {
        return $user->can('force_delete_any_caja');
    }
    ...
    {
        return $user->can('restore_any_caja');
    }
    ...
    {
        return $user->can('replicate_caja');
    }
