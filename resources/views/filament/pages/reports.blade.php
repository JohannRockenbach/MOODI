<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            <form wire:submit="exportCsv" class="space-y-4">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                    Ventas, caja, productos y ganancias del restaurante. Exportable a CSV.
                </p>
        ...
        <div class="flex flex-wrap gap-2 rounded-xl border border-gray-200 bg-white p-2 shadow-sm dark:border-gray-700 dark:bg-gray-900">
            @foreach ([
                'ventas' => 'Ventas',
                'caja' => 'Caja',
                'productos' => 'Productos',
                ...
                <button
                    ...
                    class="rounded-lg px-4 py-2 text-sm font-semibold transition {{ $activeTab === $key ? 'bg-orange-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800' }}"
                >
                    {{ $label }}
                </button>
            @endforeach
